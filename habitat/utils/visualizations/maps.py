...
# ).squeeze(1)[:, ::-1]
# TOP_DOWN_MAP_COLORS[10:] = [255,215,0]
# TOP_DOWN_MAP_COLORS[10:] = [160, 32, 240]
TOP_DOWN_MAP_COLORS[10:] = [255,105,180]
...
object_to_color_mapping = {
    'cylinder_red': 66, 'cylinder_green': 67, 'cylinder_blue': 68,
    'cylinder_yellow': 69, 'cylinder_white': 70, 'cylinder_pink': 71,
    'cylinder_black': 72, 'cylinder_cyan': 73
}
TOP_DOWN_MAP_COLORS[66] = [200, 0, 0]
TOP_DOWN_MAP_COLORS[67] = [0, 200, 0]
TOP_DOWN_MAP_COLORS[68] = [0, 0, 200]
TOP_DOWN_MAP_COLORS[69] = [255, 255, 0]
TOP_DOWN_MAP_COLORS[70] = [255,255,255]
TOP_DOWN_MAP_COLORS[71] = [255,105,180]
TOP_DOWN_MAP_COLORS[72] = [0,0,0]
TOP_DOWN_MAP_COLORS[73] = [0, 255, 255]
...
def draw_agent(
    ...
    """
    iamge = utils.draw_triangle(image, [agent_center_coord[1],agent_center_coord[0]], -agent_rotation+np.pi, radius=50, color=(63, 243, 10))
    image = utils.draw_triangle(image, [agent_center_coord[1],agent_center_coord[0]], -camera_rotation+np.pi, radius=50, color=(255, 125, 0))
    return image
